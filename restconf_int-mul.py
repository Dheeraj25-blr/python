...
for int_configs in range(0, user_input):
    ...
    if user_choice == 1:
        ...
        csr_url = f"https://192.168.196.129/restconf/data/ietf-interfaces:interfaces/interface={int_name}"
        int_type = "ethernetCsmacd"

    elif user_choice == 2:
        int_name = "Loopback" + input("Enter the Loopback Interface number (for eg. 1 for Loopback1): ")
        csr_url = "https://192.168.196.129/restconf/data/ietf-interfaces:interfaces"
